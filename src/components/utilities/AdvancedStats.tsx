...
const AdvancedStats: React.FC<ReadonlyAdvancedStatsProps> = ({ className }) => {
  ...
  const advancedMetrics = useMemo(() => {
    ...
    const completedAssignments = assignments.filter(a => a.estado === "completado").length;
    const activeAssignments = assignments.filter(a => a.estado === "activo").length;
    const productivity = activeAssignments > 0 
      ? (completedAssignments / (completedAssignments + activeAssignments)) * 100 
      : 0;
    ...
    return {
      ...
      avgBlocksPerTerritory: territories.length > 0 
  ...
  return (
    <div className={`space-y-6 ${className}`}>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
              ...
              <h3 className="font-semibold text-gray-900">Utilización Territorial</h3>
              <p className="text-sm text-gray-600">Territorios con asignaciones activas</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
              ...
              <p className="text-sm text-gray-600">Asignaciones completadas vs activas</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
              ...
              <p className="text-sm text-gray-600">De {stats.users.total} registrados</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
              ...
              <h3 className="font-semibold text-gray-900">Manzanas/Territorio</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border">
          <div className="p-6 border-b border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">📞 Estados de Teléfonos</h3>
            <p className="text-sm text-gray-600">Distribución por estado de llamada</p>
          </div>
          <div className="p-6">
            <div className="space-y-3">
              {Object.entries(advancedMetrics.phonesByStatus)
                .sort(([,a], [,b]) => b - a)
                .map(([status, count]) => {
                  const percentage = Object.values(advancedMetrics.phonesByStatus).reduce((a, b) => a + b, 0) > 0 
                    ? (count / Object.values(advancedMetrics.phonesByStatus).reduce((a, b) => a + b, 0)) * 100 
                    : 0;
                  ...
                  return (
                    <div key={status} className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-sm text-gray-600">{count} números</span>
                      </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border">
          <div className="p-6 border-b border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">👥 Distribución de Roles</h3>
            <p className="text-sm text-gray-600">Usuarios por tipo de rol</p>
          </div>
          <div className="p-6">
            <div className="space-y-4">
              {Object.entries(advancedMetrics.usersByRole).map(([role, count]) => {
                ...
                return (
                  <div key={role} className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className={`w-3 h-3 rounded-full ${roleColors[role] || "bg-gray-400"}`}></div>
                      <span className="font-medium text-gray-900">{roleLabels[role] || role}</span>
                    </div>
                    <div className="flex items-center space-x-3">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100">
        <div className="p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">💡 Insights del Sistema</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-xl">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Utilización de Territorios</h4>
            ...
            <div className="bg-white p-4 rounded-xl">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 mb-1">Rendimiento General</h4>
                  <p className="text-sm text-gray-600">
                    {(() => {
